...
casual_end_station = casual_df.groupby("end_station_name")[["ride_length"]].count().reset_index()
...
casual_start_station = casual_df.groupby("start_station_name")[["ride_length"]].count().reset_index()
...
member_end_station = member_df.groupby("end_station_name")[["ride_length"]].count().reset_index()
...
member_start_station = member_df.groupby("start_station_name")[["ride_length"]].count().reset_index()
